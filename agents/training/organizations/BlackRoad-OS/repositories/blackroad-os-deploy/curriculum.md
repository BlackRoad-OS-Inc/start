# blackroad-os-deploy — Agent Training Curriculum

**Type:** paas | **Language:** javascript

## Overview

Self-hosted Railway/Heroku

## Learning Objectives

1. Understand the purpose and architecture of blackroad-os-deploy
