# blackroad-os-core — Agent Training Curriculum

**Type:** system | **Language:** javascript

## Overview

Desktop UI, backend, auth, state

## Learning Objectives

1. Understand the purpose and architecture of blackroad-os-core
