# blackroad-operator — Agent Training Curriculum

**Type:** cli | **Language:** bash+typescript

## Overview

105 CLI tools, fleet management

## Learning Objectives

1. Understand the purpose and architecture of blackroad-operator
